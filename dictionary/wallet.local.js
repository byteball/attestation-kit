module.exports = {
    ...
    ASK_VERIFY_FN: (address, data) => `Please sign this message to prove that you own the address: [${address}](sign-message-request: I own the address: ${address}` + (data ? `\n. And I want to attest the following data:\n${Object.entries(data).map(([key, value]) => `${key}: ${value}`).join(', ')})` : ')'),
